...
BULLET_HIT_SOUND = pygame.mixer.Sound("SpaceInvader\Assets\Grenade+1.mp3")
BULLET_FIRE_SOUND = pygame.mixer.Sound("SpaceInvader\Assets\Gun+Silencer.mp3")
...
YELLOW_SPACESHIP_IMAGE = pygame.image.load("SpaceInvader\Assets\Shipright.png")
...
RED_SPACESHIP_IMAGE = pygame.image.load("SpaceInvader\Assets\Shipleft.png")
...
SPACE = pygame.transform.scale(pygame.image.load("SpaceInvader\Assets\Space.png") ,(WIDTH,HEIGHT))
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == RED_HIT:
                    red_health = red_health-1 #OR red_health -= 1  
                    BULLET_HIT_SOUND.play()
                     
            
            if event.type == YELLOW_HIT:
                    yellow_health = yellow_health-1 #OR red_health -= 1  
                    BULLET_HIT_SOUND.play()
        winner_text = ""         
        if red_health <= 0:
